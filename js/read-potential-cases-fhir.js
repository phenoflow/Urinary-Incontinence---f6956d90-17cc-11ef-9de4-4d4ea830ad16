...
(async () => {
  ...
  await fs.writeFile("urinary-incontinence-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("urinary-incontinence-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
